	...
	$(document).ready(function ($) {
		...
		class NAV_TYPE_1 {
			constructor() {
				...
				this.searchForm = this.navigation.find('.search-form-wrapper');
			}
		...
		const NAVIGATION_TYPE_2 = new NAV_TYPE_2();
		...
		$(COMMON.body).imagesLoaded({background: '.bg_img'}, function () {
			...
			NAVIGATION_TYPE_1.init();
			NAVIGATION_TYPE_2.init();
			NAVIGATION_TYPE_MOBILE.init();
			AOS.init();
